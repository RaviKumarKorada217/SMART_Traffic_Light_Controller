...
HD_PWD='D:/vivado projects/SMART_Traffic_Light_Controller_2/SMART_Traffic_Light_Controller_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic_system_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source traffic_system_tb.tcl
